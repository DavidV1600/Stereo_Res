...
if __name__ == "__main__":
    # === Train on Original VOC ===
    print("Training on original VOC...")
    model_orig, _ = train_model(
        data_yaml='./data/VOC_YOLO/dataset.yaml',  # adjust path
        exp_name='voc_orig_baseline'
    )
    evaluate_and_export(model_orig, 'voc_orig')
